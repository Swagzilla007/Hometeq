...
$password1=trim($_POST['r_password1']);   //What trim() Removes:Spaces,Tabs,Newlines,Carriage returns,Null bytes,Other predefined characters

$password2=trim($_POST['r_password2']);

//create a regular expression variable
$reg = "/^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$/"; //regular expression for email validation
